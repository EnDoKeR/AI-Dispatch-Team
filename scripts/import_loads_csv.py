...
def normalize_row(row):
    ...
    broker_name = first_value(
        row,
        ["broker_name", "broker", "company", "company_name"],
    )

    broker_mc = first_value(
        row,
        ["broker_mc", "mc", "mc_number", "broker_mc_number"],
    )

    broker_contact_raw = first_value(
        row,
        ["broker_contact", "contact", "contact_info", "phone", "email"],
    )

    reference_id = first_value(
        row,
        ["reference_id", "ref", "ref_id", "load_id", "reference"],
    )
    ...
    original_pickup_time = first_value(
        row,
        ["pickup_time", "pickup_window", "pickup_appointment"],
    )
