...
def _write_load_generated_resolver_provenance_sidecars_if_enabled(
    ...
    return {
        ...
        "adapter_input_count": summary.get("adapter_input_count", 0),
        "adapter_output_count": summary.get("adapter_output_count", 0),
        "dedupe_input_count": summary.get("dedupe_input_count", 0),
        "dedupe_output_count": summary.get("dedupe_output_count", 0),
        "adapter_detail_lost_count": summary.get("adapter_detail_lost_count", 0),
        "dedupe_detail_lost_count": summary.get("dedupe_detail_lost_count", 0),
