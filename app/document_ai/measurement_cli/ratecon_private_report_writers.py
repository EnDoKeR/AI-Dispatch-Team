"""Local-only safe report writers for private RateCon measurement summaries."""
...
def _safe_csv_row(row):
    return {
        ...
        "generic_stop_count": row.get("generic_stop_count", 0),
...
def write_private_ratecon_safe_summary_json(
    rows,
    aggregate,
    output_dir=None,
    allow_custom_output_dir=False,
):
    return write_safe_summary_json(
        rows,
        aggregate,
...
def write_private_ratecon_safe_summary_csv(
    rows,
    output_dir=None,
    allow_custom_output_dir=False,
):
    return write_safe_summary_csv(
        rows,
        output_dir=output_dir,
        allow_custom_output_dir=allow_custom_output_dir,
    )
...
def write_private_ratecon_safe_aggregate_json(
    aggregate,
    output_dir=None,
    allow_custom_output_dir=False,
):
    return write_safe_aggregate_json(
        aggregate,
        output_dir=output_dir,
        allow_custom_output_dir=allow_custom_output_dir,
    )
...
def write_private_ratecon_safe_aggregate_md(
    aggregate,
    output_dir=None,
    allow_custom_output_dir=False,
):
    return write_safe_aggregate_md(
        aggregate,
        output_dir=output_dir,
        allow_custom_output_dir=allow_custom_output_dir,
    )
...
def write_private_ratecon_value_review_template_csv(
    rows,
    output_dir=None,
    allow_custom_output_dir=False,
):
    return write_value_review_template_csv(
        rows,
        output_dir=output_dir,
        allow_custom_output_dir=allow_custom_output_dir,
    )
...
def write_private_ratecon_safe_outputs(
    rows,
    aggregate,
    output_dir=None,
    write_json=False,
    ...
    return write_private_measurement_outputs(
        rows,
        aggregate,
        output_dir=output_dir,
        ...
        write_csv=write_csv,
        write_md=write_md,
        write_value_review_template=write_value_review_template,
        allow_custom_output_dir=allow_custom_output_dir,
    )


def write_private_ratecon_local_exports(
    rows,
    aggregate,
    output_dir=None,
    write_json=False,
    ...
    return write_private_ratecon_safe_outputs(
        rows,
        aggregate,
        output_dir=output_dir,
        write_json=write_json,
