...
LOAD_IDENTIFIER_TYPE_PRIORITY = {
    LOAD_IDENTIFIER_TYPE_BROKER_LOAD_NUMBER: 1,
    LOAD_IDENTIFIER_TYPE_ORDER_NUMBER: 2,
    LOAD_IDENTIFIER_TYPE_TENDER_ID: 3,
    LOAD_IDENTIFIER_TYPE_FREIGHT_BILL_NUMBER: 4,
    LOAD_IDENTIFIER_TYPE_PRO_NUMBER: 5,
    LOAD_IDENTIFIER_TYPE_SHIPMENT_NUMBER: 6,
    LOAD_IDENTIFIER_TYPE_DISPATCH_NUMBER: 7,
    LOAD_IDENTIFIER_TYPE_TRIP_NUMBER: 8,
    LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE: 9,
}
...
MEDIUM_CONTEXTUAL_IDENTIFIER_LABELS = {
    ...
    "ref no": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "reference #": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "reference no": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "reference number": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "reference id": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "confirmation #": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "confirmation no": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "confirmation number": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "booking #": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "booking no": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "booking number": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "tender ref": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
    "tender reference": LOAD_IDENTIFIER_TYPE_PRIMARY_REFERENCE,
}
...
def identifier_type_priority(value):
    return LOAD_IDENTIFIER_TYPE_PRIORITY.get(normalize_identifier_type(value), 99)
