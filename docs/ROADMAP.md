...
2. Use the JSON-ready intake record helper as the stable target for future parser work.
...
4. Recommended next target: manual intake dry-run summary helper/CLI.
