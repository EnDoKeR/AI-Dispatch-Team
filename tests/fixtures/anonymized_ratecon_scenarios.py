...
""".strip(),
    ...
    {
        "scenario_id": "user_table_all_core_present",
        "scenario_name": "User review table all core fields present",
        "text": """
Customer | LOAD | Pick up (City, State Zip) | PickUP Date | Delivery (City, State Zip) | Delivery Date | Load No. | Loaded Miles | Rate / commodity / weight
FAKE BROKER LLC | FAKE LOAD | Fake City, ST 00000 | 2026-12-01 | Fake Town, ST 00000 | 2026-12-02 | FAKE-REF-028 | | $0000.00 / FAKE PRODUCT / 40000 LBS
""".strip(),
        "expected_present_fields": [
            "customer_name",
            "load_label",
    ...
    {
        "scenario_id": "user_table_missing_loaded_miles_only",
        "scenario_name": "User review table missing loaded miles only",
        "text": """
Customer | LOAD | Pick up (City, State Zip) | PickUP Date | Delivery (City, State Zip) | Delivery Date | Load No. | Loaded Miles | Rate / commodity / weight
FAKE BROKER LLC | FAKE LOAD | Fake City, ST 00000 | 2026-12-03 | Fake Town, ST 00000 | 2026-12-04 | FAKE-REF-029 | | $0000.00 / FAKE PRODUCT / 40000 LBS
""".strip(),
        "expected_present_fields": [
            "customer_name",
            "load_label",
    ...
    {
        "scenario_id": "user_table_missing_broker_mc_core_present",
        "scenario_name": "User review table broker MC absent but core present",
        "text": """
Customer | LOAD | Pick up (City, State Zip) | PickUP Date | Delivery (City, State Zip) | Delivery Date | Load No. | Rate / commodity / weight
FAKE BROKER LLC | FAKE LOAD | Fake City, ST 00000 | 2026-12-05 | Fake Town, ST 00000 | 2026-12-06 | FAKE-REF-030 | $0000.00 / FAKE PRODUCT / 40000 LBS
""".strip(),
        "expected_present_fields": [
            "customer_name",
            "load_label",
    ...
    {
        "scenario_id": "user_table_missing_equipment_core_present",
        "scenario_name": "User review table equipment absent but core present",
        "text": """
Customer | LOAD | Pick up (City, State Zip) | PickUP Date | Delivery (City, State Zip) | Delivery Date | Load No. | Rate / commodity / weight
FAKE BROKER LLC | FAKE LOAD | Fake City, ST 00000 | 2026-12-07 | Fake Town, ST 00000 | 2026-12-08 | FAKE-REF-031 | $0000.00 / FAKE PRODUCT / 40000 LBS
""".strip(),
        "expected_present_fields": [
            "customer_name",
            "load_label",
    ...
    {
        "scenario_id": "user_table_missing_commodity",
        "scenario_name": "User review table missing commodity",
        "text": """
Customer | LOAD | Pick up (City, State Zip) | PickUP Date | Delivery (City, State Zip) | Delivery Date | Load No. | Rate / commodity / weight
FAKE BROKER LLC | FAKE LOAD | Fake City, ST 00000 | 2026-12-09 | Fake Town, ST 00000 | 2026-12-10 | FAKE-REF-032 | $0000.00 / / 40000 LBS
""".strip(),
        "expected_present_fields": [
            "customer_name",
            "load_label",
    ...
    {
        "scenario_id": "user_table_missing_weight",
        "scenario_name": "User review table missing weight",
        "text": """
Customer | LOAD | Pick up (City, State Zip) | PickUP Date | Delivery (City, State Zip) | Delivery Date | Load No. | Rate / commodity / weight
FAKE BROKER LLC | FAKE LOAD | Fake City, ST 00000 | 2026-12-11 | Fake Town, ST 00000 | 2026-12-12 | FAKE-REF-033 | $0000.00 / FAKE PRODUCT /
""".strip(),
        "expected_present_fields": [
            "customer_name",
            "load_label",
    ...
    {
        "scenario_id": "user_table_missing_pickup_delivery_dates",
        "scenario_name": "User review table missing pickup and delivery dates",
        "text": """
Customer | LOAD | Pick up (City, State Zip) | PickUP Date | Delivery (City, State Zip) | Delivery Date | Load No. | Rate / commodity / weight
FAKE BROKER LLC | FAKE LOAD | Fake City, ST 00000 | | Fake Town, ST 00000 | | FAKE-REF-034 | $0000.00 / FAKE PRODUCT / 40000 LBS
""".strip(),
        "expected_present_fields": [
            "customer_name",
            "load_label",
    ...
    {
        "scenario_id": "user_table_load_number_loaded_miles_merged",
        "scenario_name": "User review table load number merged near loaded miles",
        "text": """
Customer | LOAD | Pick up (City, State Zip) | PickUP Date | Delivery (City, State Zip) | Delivery Date | Load No. / Loaded Miles | Rate / commodity / weight
FAKE BROKER LLC | FAKE LOAD | Fake City, ST 00000 | 2026-12-13 | Fake Town, ST 00000 | 2026-12-14 | FAKE-REF-035 / | $0000.00 / FAKE PRODUCT / 40000 LBS
""".strip(),
        "expected_present_fields": [
            "customer_name",
            "load_label",
